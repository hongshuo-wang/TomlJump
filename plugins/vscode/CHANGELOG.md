...
- 使用稳定版 VS Code Extension API，同一个 VSIX 可安装到兼容版本的 VS Code、Cursor 与 Trae。
...
- Used the stable VS Code Extension API so the same VSIX can run in compatible VS Code, Cursor, and Trae versions.
